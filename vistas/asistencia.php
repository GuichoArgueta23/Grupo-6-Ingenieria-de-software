...
<html>
  <head>
    ...
    <title>ASOCIACION FARMACEUTICA</b></title>
    ...
    <link rel="shortcut icon" href="../admin/public/img/virus.ico">
...
<?php 
 //include '../ajax/asistencia.php' ?>
  ...
  <div class="lockscreen-logo">
    <a href="#"> ASOCIACION<b><br>FARMACEUTICA</b></a>
  </div>
  <!-- User name -->
  ...
  <div class="lockscreen-item">
    ...
    <div class="lockscreen-image">
      <img src="../admin/files/negocio/pill.ico" alt="User Image">
    </div>
    <!-- /.lockscreen-image -->
  ...
  <div class="help-block text-center">
    Usa el lector de Barrras para registrarte
  </div>
